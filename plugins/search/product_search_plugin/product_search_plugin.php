...
echo "We were unable to load Joobi library for the plugin Joobi - Products search. If you removed the joobi folder, please also remove this plugin from the Joomla plugin manager.";
}