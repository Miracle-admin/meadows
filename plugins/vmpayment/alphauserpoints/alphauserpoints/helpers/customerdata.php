...
class AlphauserpointsHelperCustomerData {
...
//    private $_pending_reason = '';
	...
	public function load() {
		...
		$sessionData = $session->get('alphauserpoints', 0, 'vm');
...
//		$sessionData->pending_reason = $this->_pending_reason;
		...
		$session->set('alphauserpoints', json_encode($sessionData), 'vm');
	}
...
//		$this->_pending_reason = '';
	...
	public function clear() {
		$session = JFactory::getSession();
		$session->clear('alphauserpoints', 'vm');
	}
