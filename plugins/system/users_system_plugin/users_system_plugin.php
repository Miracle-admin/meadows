...
echo "We were unable to load Joobi library for the plugin Joobi - Users Edit. If you removed the joobi folder, please also remove this plugin from the Joomla plugin manager.";
}