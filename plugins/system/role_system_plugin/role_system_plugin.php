...
echo "We were unable to load Joobi library for the plugin Joobi - Role Restriction for Joomla Components. If you removed the joobi folder, please also remove this plugin from the Joomla plugin manager.";
}