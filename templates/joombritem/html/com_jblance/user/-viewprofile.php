...
<form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="viewProfile" class="form-horizontal">
      ...
      <div class="span5">
        ...
        <div class="row-fluid">
          <div class="span12">
            ...
            <a href="<?php echo $link_invite; ?>" class="btn btn-success btn-block btn-large jb-modal" rel="{handler: 'iframe', size: {x: 650, y: 400}}"><i class="icon-envelope icon-white"></i> <?php echo JText::_('COM_JBLANCE_INVITE_TO_PROJECT'); ?></a> </div>
        </div>
        <div class="sp10">&nbsp;</div>
        <div class="row-fluid">
          <div class="span6">
          ...
          <div class="span6"> <a class="btn btn-block" href="<?php echo $link_sendpm; ?>"><i class="icon-comment"></i> <?php echo JText::_('COM_JBLANCE_SEND_MESSAGE'); ?></a> </div>
        </div>
        <?php endif; ?>
      </div>
      <div class="span7">
        ...
        <div class="control-group">
          ...
          <div class="controls"> <?php echo $this->userInfo->biz_name; ?> </div>
        </div>
        <?php endif; ?>
        ...
        <div class="control-group">
          ...
          <div class="controls"> <?php echo JblanceHelper::formatCurrency($this->userInfo->rate, true, true).' / '.JText::_('COM_JBLANCE_HOUR'); ?> </div>
        </div>
        <div class="control-group">
          <label class="control-label nopadding"><?php echo JText::_('COM_JBLANCE_SKILLS'); ?>: </label>
          <div class="controls"> <?php echo JblanceHelper::getCategoryNames($this->userInfo->id_category); ?> </div>
        </div>
        <?php endif; ?>
        <div class="control-group">
  ...
  <fieldset>
    ...
    <div class="control-group">
      ...
      <div class="controls"> <?php echo nl2br($this->userInfo->address); ?> </div>
    </div>
    <div class="control-group">
      <label class="control-label nopadding"><?php echo JText::_('COM_JBLANCE_LOCATION'); ?>: </label>
      <div class="controls"> <?php echo JblanceHelper::getLocationNames($this->userInfo->id_location); ?> </div>
    </div>
    <div class="control-group">
      <label class="control-label nopadding"><?php echo JText::_('COM_JBLANCE_ZIP_POSTCODE'); ?>: </label>
      <div class="controls"> <?php echo $this->userInfo->postcode; ?> </div>
    </div>
    <div class="control-group">
      <label class="control-label nopadding"><?php echo JText::_('COM_JBLANCE_CONTACT_NUMBER'); ?>: </label>
      <div class="controls"> <?php echo $this->userInfo->mobile; ?> </div>
    </div>
  </fieldset>
  <?php endif; ?>
  ...
  <ul class="nav ml-40 nav-tabs">
    <li class="active"><a data-toggle="tab" href="#Work">Work</a></li>
    <li><a data-toggle="tab" href="#MyWidgets">My Widgets</a></li>
    <li><a data-toggle="tab" href="#AppMeadowscertificates">certificates</a></li>
    <li><a data-toggle="tab" href="#Testimonials">Testimonials</a></li>
    <li><a data-toggle="tab" href="#yourexperience">Your Experience</a></li>
    <li><a data-toggle="tab" href="#qualifications">Your Qualifications</a></li>
  </ul>
  ...
  <div class="tab-content box-border-ct">
    ...
    <div id="MyWidgets" class="tab-pane fade">
      <h3>Menu 1</h3>

    </div>
    <div id="AppMeadowscertificates" class="tab-pane fade">
      <h3>Menu 2</h3>
    ...
    <div id="yourexperience" class="tab-pane fade">
      <h3>Menu 2</h3>
  ...
  <div class="page-actions">
    ...
    <?php endif; ?>
    <?php if($isMine) : ?>
    <div id="edit-profile" class="page-action"> <a href="<?php echo $link_edit_profile; ?>"><i class="icon-edit"></i> <?php echo JText::_('COM_JBLANCE_EDIT_PROFILE'); ?></a> </div>
    <?php else : ?>
    <?php if($enableReporting) : ?>
    <div id="report-this" class="page-action"> <a href="<?php echo $link_report; ?>"><i class="icon-warning-sign"></i> <?php echo JText::_('COM_JBLANCE_REPORT_USER'); ?></a> </div>
    <?php endif; ?>
    <div id="send-message" class="page-action"> <a href="<?php echo $link_sendpm; ?>"><i class="icon-comment"></i> <?php echo JText::_('COM_JBLANCE_SEND_MESSAGE'); ?></a> </div>
    <?php endif; ?>
  </div>
    ...
    <ul class="thumbnails">
      <?php 
		for($i=0, $n=count($this->portfolios); $i < $n; $i++){
			...
			?>
      <li class="span3">
        <div class="thumbnail"> <img style="width:200px; height:200px;" src="<?php echo $imgLoc; ?>" alt="" title="">
          <div class="caption">
  ...
  <?php endif; ?>
  <?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'freelancer')); ?> <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'freelancer', JText::_('COM_JBLANCE_FREELANCER', true)); ?> 
  <!-- project history -->
    ...
    <table class="table table-bordered table-hover table-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td data-title="<?php echo JText::_('COM_JBLANCE_PROJECT_NAME'); ?>"><?php echo LinkHelper::getProjectLink($fproject->id, $fproject->project_title); ?></td>
          <td data-title="<?php echo JText::_('COM_JBLANCE_RATED_BY'); ?>"><?php echo LinkHelper::GetProfileLink($fproject->publisher_userid, $buyer->$nameOrUsername); ?></td>
          <td data-title="<?php echo JText::_('COM_JBLANCE_RATING_FROM_PUBLISHER'); ?>"><?php
				$rate = JblanceHelper::getUserRateProject($fproject->assigned_userid, $fproject->id);
				JblanceHelper::getRatingHTML($rate);
				?></td>
          <td data-title="<?php echo JText::_('COM_JBLANCE_COMMENTS'); ?>"><?php 
				if($rate > 0)
  ...
  <div id="no-more-tables">
    <table class="table table-bordered table-hover table-striped">
      ...
      <tbody>
        ...
        <tr>
          <td data-title="#"><?php echo $i+1;?></td>
          <td data-title="<?php echo JText::_('COM_JBLANCE_PROJECT_NAME'); ?>"><?php echo LinkHelper::getProjectLink($bproject->id, $bproject->project_title); ?></td>
          <td data-title="<?php echo JText::_('COM_JBLANCE_RATED_BY'); ?>"><?php echo LinkHelper::GetProfileLink($bproject->assigned_userid, $freelancer->$nameOrUsername); ?></td>
          <td data-title="<?php echo JText::_('COM_JBLANCE_RATING_FROM_FREELANCER'); ?>"><?php
...
<!-- display the extra profile fields module-->
<?php 
$pos = "developer_profile_fields";
