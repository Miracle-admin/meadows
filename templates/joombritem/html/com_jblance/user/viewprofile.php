...
<div class="public-profile">
  <div  class="col-md-9">
    <form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="viewProfile" class="form-horizontal">
      <?php /*?><div class="jbl_h3title"><?php echo JText::_('COM_JBLANCE_PROFILE').' - '.$this->userInfo->name; ?></div><?php */?>
      
      <!-- Do not show send message & edit link to the profile owner -->
      <div class="page-actions">
        <?php /*?><?php if($enableAddThis & !$isMine) : ?>
      ...
      <fieldset>
        ...
        <div class="row">
          <div class="col-md-3">
            ...
            <div class="control-group ratinguser-col">
              <?php /*?><label class="control-label nopadding"><?php echo JText::_('COM_JBLANCE_AVERAGE_RATING'); ?>: </label><?php */?>
          ...
          <div class="col-md-9">
            <h2 style="margin-bottom:10px;"><?php echo  $this->userInfo->name; ?> <?php /*?><small><?php echo  $this->userInfo->username; ?></small><?php */?></h2>
            ...
            <div class="row">
              <div class="">
                ...
                <a href="<?php echo $link_invite; ?>" class="btn btn-success btn-block btn-large jb-modal" rel="{handler: '', size: {x: 650, y: 400}}"><i class="icon-envelope icon-white"></i> <?php echo JText::_('COM_JBLANCE_INVITE_TO_PROJECT'); ?></a> </div>
            </div>
            <div class="row">
              <div class="">
                <?php 
              ...
              <div class=""> <a class="btn btn-block" href="<?php echo $link_sendpm; ?>"><i class="icon-comment"></i> <?php echo JText::_('COM_JBLANCE_SEND_MESSAGE'); ?></a> </div>
            </div>
            <?php endif; ?>
          </div>
        </div>
