...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-12"><form action="<?php echo $action; ?>" method="post" name="userform">
    ...
    ?>
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="project_row_title"><?php echo LinkHelper::getProjectLink($row->id, $row->project_title); ?></div>

                            <?php echo substr($row->description, 0, 200); ?><br>
                            ...
                            <strong><?php echo JText::_('COM_JBLANCE_SKILLS_REQUIRED'); ?></strong> : <span class="medium mr-rt-50"><?php echo JblanceHelper::getCategoryNames($row->id_category); ?> </span>


                            <strong><?php echo JText::_('COM_JBLANCE_LOCATION'); ?></strong> : <span class="medium"><?php echo JblanceHelper::getLocationNames($row->id_location); ?></span>
