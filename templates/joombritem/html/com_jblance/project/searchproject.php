      		...
      		<div class="control-group">
				...
				<div class="controls">
					<label class="checkbox inline" for="">
						<input onclick="this.form.submit()" type="checkbox" id="fixed" name="project_type[fixed]" value="COM_JBLANCE_FIXED" <?php if(isset($proj_type['fixed'])) {echo 'checked'; } ?> ><?php echo JText::_('COM_JBLANCE_FIXED'); ?>
					</label> 
					<label class="checkbox inline">
						<!-- <input type="hidden" name="project_type['hourly']" value="0" /> -->
						<input type="checkbox" onclick="this.form.submit()" id="hourly" name="project_type[hourly]" value="COM_JBLANCE_HOURLY" <?php if(isset($proj_type['hourly'])) {echo 'checked';} ?> ><?php echo JText::_('COM_JBLANCE_HOURLY'); ?>
					</label> 
				</div>
			</div>
		</div>
      		...
      		<!--Body content-->
				...
				<div class="row-fluid">
					...
					<div class="span6">
						...
						<div class="font14">
							<strong><?php echo JText::_('COM_JBLANCE_SKILLS_REQUIRED'); ?></strong> : <?php 
						
						    echo SelectHelper::getCategName($row->id_category);
							
							//echo JblanceHelper::getCategoryNames($row->id_category); 
							?>
						</div>
						<div class="font14">
