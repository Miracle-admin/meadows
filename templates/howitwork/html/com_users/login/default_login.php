	...
	<form action="<?php echo JRoute::_('index.php?option=com_users&task=user.login'); ?>" method="post" class="form-validate form-horizontal">
		...
		<fieldset class="col-md-12">
			...
			<div  class="form-group">
				<div class="col-md-6 row"><input id="remember" type="checkbox" name="remember" class="inputbox" value="yes"/><label><?php echo JText::_('COM_USERS_LOGIN_REMEMBER_ME') ?></label></div>
			...
			<div class="form-group">
				<div class="">
					<button type="submit" class="login_sumbmit">
