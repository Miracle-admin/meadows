...
function pagination_item_inactive(&$item)
{
	...
	if ($item->text == JText::_('JLIB_HTML_START'))
	{
		return '<li class=""><a><i class="fa fa-angle-double-left"></i></a></li>';
	}

	// Check for "Prev" item
	if ($item->text == JText::_('JPREV'))
	{
		return '<li class=""><a><i class="fa fa-angle-left"></i></a></li>';
	}

	// Check for "Next" item
	if ($item->text == JText::_('JNEXT'))
	{
		return '<li class=""><a><i class="fa fa-angle-right"></i></a></li>';
	}

	// Check for "End" item
	if ($item->text == JText::_('JLIB_HTML_END'))
	{
		return '<li class=""><i class="fa fa-angle-double-right"></i>
</li>';
	}
