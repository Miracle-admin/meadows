...
<form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="editProfile" id="frmEditProfile" class="edit-profile-wrapper form-validate form-horizontal" onsubmit="return validateForm(this);" enctype="multipart/form-data">
  ...
  <fieldset class="extra_fields">
    ...
    <div style= "<?php echo $hidden; ?>"  id="entry-<?php echo $fields[$i]; ?>" class="clonedInput_0  clone">
      ...
      <fieldset id="apps">
        <div class="control-group">
          ...
          <div class="controls">
            <input data-validation="length" data-validation-length="max50" data-validation-optional="true" <?php echo $disabled; ?> class="input-large" value="<?php echo $this->extra_fields['field_id_1'][$i]; ?>" type="text" name="field_id_1[]" id="field_id_1" value="" />
    ...
    <div class="up_subscription upsbscr_yourapps">
      ...
      <div class="renewsubscription"> <a href="#">Upgrade To Silver Geek</a> </div>
    </div>
    <?php } ?>
    ...
    <div class="up_subscription upsbscr_exp">
      ...
      <div class="renewsubscription"> <a href="#">Upgrade To Gold Geek</a> </div>
    </div>
    <?php } ?>
    <?php if($goldAccess) { for($i=0;$i<5;$i++) {  
	$hidden =$i>0?"display:none;":"display:block;";
    ...
    <div class="up_subscription upsubscr_yourweb">
      ...
      <div class="renewsubscription"> <a href="#">Upgrade To Platinum Geek</a> </div>
    </div>
    <?php } ?>
    <?php if($platinumAccess) { for($i=0;$i<5;$i++) {  
	$hidden =$i>0?"display:none;":"display:block;";
