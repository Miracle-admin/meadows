...
<form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="userForm">
	...
	<div class="row-fluid">
		...
		<div class="span6">
			...
			<p>
				<a href="<?php echo $link_progress; ?>" class="btn"><?php echo JText::_('COM_JBLANCE_VIEW_PROGRESS'); ?></a>
				<?php 
				...
				<a href="<?php echo $link_rate; ?>" class="btn"><?php echo JText::_('COM_JBLANCE_RATE_SELLER'); ?></a>
				<?php } ?>
			</p>
		</div>
