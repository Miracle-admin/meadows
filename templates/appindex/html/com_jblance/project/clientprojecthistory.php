...
<div class="mtb-40">
  <form action="<?php echo $action; ?>" method="post" name="userForm">
    ...
    <div class="row-fluid">
      ...
      <div class="span6">
        <h3 class="media-heading"> <?php echo LinkHelper::getProjectLink($row->id, $row->project_title); ?> </h3>
        <div class="font14"> <strong><?php echo JText::_('COM_JBLANCE_POSTED_BY'); ?></strong> : <?php echo LinkHelper::GetProfileLink($row->publisher_userid, $buyer->biz_name); ?> </div>
        <div class="font14"> <strong><?php echo JText::_('COM_JBLANCE_SKILLS_REQUIRED'); ?></strong> : <?php echo JblanceHelper::getCategoryNames($row->id_category); ?> </div>
        <div class="font14"> <strong><?php echo JText::_('COM_JBLANCE_LOCATION'); ?></strong> : <span class="small"><?php echo JblanceHelper::getLocationNames($row->id_location); ?></span> </div>
        <ul class="promotions">
      ...
      <div > <a href="<?php echo JUri::root(); ?>index.php?option=com_jblance&view=membership&layout=managepay" style="border: 1px solid;background: red;color: #fff;padding: 8px;border-radius: 8px;">View Payments</a> </div>
      <div > <a href="#" style="border: 1px solid;background: #0600FF;color: #fff;padding: 8px;border-radius: 8px;float: left;
    margin: 10px 0 0 0;"  >See PO's Review</a> </div>
    </div>
	...
	?>
    <br>
    <a href="<?php echo $link_search; ?>" class=" btn btn-primary"><?php echo JText::_('COM_JBLANCE_SEARCH_PROJECTS'); ?></a>
