      ...
      <div class="validate-top-row">
        ...
        <div class=" col-md-4">
          <div class="deposited box-border-ct">
            ...
            <a class="btna" href="<?php echo JRoute::_(JUri::base()."index.php?option=com_jblance&task=project.upgradeproject&assisted=1&id=".JRequest::getInt('id').'&'.JSession::getFormToken()."=1"); ?>">Make your project Assisted</a> <span>If you need help, contact <a href="mailto:projects@appmeadows.com">projects@appmeadows.com</a></span> </div>
        </div>
        <?php } ?>
      </div>
