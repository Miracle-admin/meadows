...
<!--
	...
	function validateForm() {			
		...
		if(btn == null){
			...
			if(!$$('input[name="gateway"]:checked')[0]){
	...
	function checkZeroPlan(planAmt, planId){
		...
		var myFx = new Fx.Scroll(window).toElement('div-gateway');
	}
//-->
</script>
<?php 
		...
		<div class="row-fluid">
			<div class="span12 pricing comparison">
				<ul class="<?php echo $span; ?>">
					<li class=""><h3><?php echo JText::_('COM_JBLANCE_PLAN_NAME'); ?></h3></li>
					<li><?php echo JText::_('COM_JBLANCE_BONUS_FUND'); ?></li>
					<?php foreach($infos as $info){ ?>
					<li><?php echo $info->key; ?></li>
					<?php } ?>
					<li class=""><h4><?php echo JText::_('COM_JBLANCE_PRICE'); ?></h4></li>
				</ul>
			<?php 
			}
			?>
				<ul class="<?php echo $span; ?>">
					<li class=""><h3><?php echo $row->name; ?></h3></li>
