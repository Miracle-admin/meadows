...
<div class="meadows_login_wrapper">
  <div class="meadows_login_outer bg-white">
    <div class="reset<?php echo $this->pageclass_sfx?>">
      ...
      <?php endif; ?>
      <form id="user-registration" action="<?php echo JRoute::_('index.php?option=com_users&task=reset.request'); ?>" method="post" class="form-validate forgot-pwd-wrap  form-horizontal ">
