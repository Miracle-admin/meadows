...
///////////////////////////////// end Category select field
	...
	if($enableprice){
				...
				echo  '<td>
				<div class="form-group"><input type="text" name="formprice1" id="formprice1" class="form-control" onkeyup="this.style.backgroundColor = \'\'" /></div>
				<div class="form-group"><label for="formprice1">'.$symbol.' ( '.$currency.' )</label><INPUT type="hidden" value="'.$currency.'" name="currency">
				</div></td>';
				echo  '</tr>';
	}
