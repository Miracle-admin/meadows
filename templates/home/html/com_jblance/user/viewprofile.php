			...
			<div class="span5 user-thumb">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<a href="<?php echo $link_invite; ?>" class="btn btn-success btn-block btn-large jb-modal" rel="{handler: '', size: {x: 650, y: 400}}"><i class="icon-envelope icon-white"></i> <?php echo JText::_('COM_JBLANCE_INVITE_TO_PROJECT'); ?></a>
					</div>
				</div>
				<div class="sp10">&nbsp;</div>
				<div class="row-fluid">
  ...
  //echo "Match found";
	...
	if(count($parents)){
		foreach($parents as $pt){
			//echo '<pre>';
			//print_r($pt);
			$ptArray= get_object_vars($pt);
			$aCCess='';
  	$aCCess=($silverAccess=='1')?array('24','26','14','18','28','22','16'):$aCCess;
  	$aCCess=($goldAccess=='1')?array('24','26','14','18','28','22','16','43','39','51','55'):$aCCess;
  	$aCCess=($platinumAccess=='1')?array('24','26','14','18','28','22','16','43','39','51','55','58','62','60','20'):$aCCess;
 			if(array_intersect($ptArray,$aCCess)) {
			?>
	<fieldset>
