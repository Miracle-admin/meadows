...
<div class="mtb-40" id="showall-bids">
  <form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="userForm">
    ...
    <div class="alert alert-info"> <?php echo JText::_('COM_JBLANCE_NO_BIDS_YET'); ?> </div>
    <?php else : ?>
    <?php
	...
	for($i=0; $i < count($this->rows); $i++){
		...
		$link_retract_bid = JRoute::_('index.php?option=com_jblance&task=project.retractbid&bidid='.$row->id.'&'.JSession::getFormToken().'=1');
		$link_edit_bid    = JRoute::_('index.php?option=com_jblance&view=project&layout=placebid&pid='.$row->proj_id);
    ...
    <div class="row-fluid">
      <div class="span5">
        <h4> <?php echo LinkHelper::getProjectLink($row->proj_id, $row->project_title); ?>
        ...
        <div class="action-bar">
          ...
          <div class="alert"> <strong><?php echo JText::_('COM_JBLANCE_BID_WON'); ?></strong><br>
            ...
            <?php echo JText::_('COM_JBLANCE_OR'); ?> <a href="javascript:void(0);" class="btn btn-danger btn-small" onclick="javascript:modalConfirm('<?php echo JText::_('COM_JBLANCE_DENY'); ?>', '<?php echo JText::_('COM_JBLANCE_CONFIRM_DENY_BID'); ?>', '<?php echo $link_deny_bid; ?>');" ><?php echo JText::_('COM_JBLANCE_DENY'); ?></a> ? </div>
          <?php	
					}
          ...
          <a href="javascript:void(0);" class="btn btn-danger btn-small" onclick="javascript:modalConfirm('<?php echo JText::_('COM_JBLANCE_RETRACT_BID'); ?>', '<?php echo JText::_('COM_JBLANCE_CONFIRM_RETRACT_BID'); ?>', '<?php echo $link_retract_bid; ?>');" ><?php echo JText::_('COM_JBLANCE_RETRACT_BID'); ?></a> <a href="<?php echo $link_edit_bid; ?>" class="btn btn-primary btn-small"><?php echo JText::_('COM_JBLANCE_EDIT_BID'); ?></a>
          <?php
				}
				?>
      ...
      <div class="span3"> <?php echo JText::_('COM_JBLANCE_STATUS'); ?> : <?php echo $model->getLabelProjectStatus($row->proj_status); ?><br>
        ...
        <?php echo JText::_('COM_JBLANCE_BID_STATUS'); ?> : <span class="label label-success"><?php echo JText::_($row->status); ?></span><br>
        <?php } ?>
      </div>
