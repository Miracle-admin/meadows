                                                ...
                                                <table width="100%" cellspacing="3" cellpadding="3" border="0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><span class="price"><?php echo $planparams->buyFeePerUrgentProject; ?></span></td>
                                                        </tr>
                                            ...
                                            <li class="grey-box">
                                                <table width="100%" cellspacing="3" cellpadding="3" border="0">
                                                    <tbody><tr>
                                                            ...
                                                            <td><span class="price"><?php echo $planparams->buyFeePerPrivateProject; ?></span></td>
                                                        </tr>
                                                    </tbody></table>          
                                            </li>
                                        <?php } ?>                               
                                            ...
                                            <li class="grey-box">
                                                <table width="100%" cellspacing="3" cellpadding="3" border="0">
                                                    <tbody><tr>
                                                            ...
                                                            <td><span class="price"><?php echo $planparams->buyFeePerFeaturedProject; ?></span></td>
                                                        </tr>
                                                    </tbody></table>          
                                            </li>
                                        <?php } ?>
                                            ...
                                            <li class="grey-box">
                                                <table width="100%" cellspacing="3" cellpadding="3" border="0">
                                                    <tbody><tr>
                                                            ...
                                                            <td><span class="price"><?php echo $planparams->buyFeePerAssistedProject; ?></span></td>
                                                        </tr>
                                                    </tbody></table>          
                                            </li>
