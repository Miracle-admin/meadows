...
<!--
	function validateForm(f){
		...
		if(!$$('input[name="id_category[]"]:checked')[0]){
			alert('<?php echo JText::_('COM_JBLANCE_PLEASE_SELECT_CATEGORY_FROM_THE_LIST', true); ?>');
			return false;
		}
		...
		if(!desc.length === 0 || !desc.trim()){
			alert('<?php echo JText::_('COM_JBLANCE_PLEASE_ENTER_DESCRIPTION', true); ?>');
			return false;
		}
...
<form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="userFormProject" id="userFormProject" class="form-validate form-horizontal" onsubmit="return validateForm(this);" enctype="multipart/form-data">
	...
	<a class="" data-toggle="collapse" data-target="#more-options"><?php echo JText::_('COM_JBLANCE_MORE_OPTIONS'); ?> &raquo;</a></p>
	<?php } ?>
	...
	<fieldset>
		...
		<ul class="upgrades">
			...
			<!--Private invite hidden <li class="project_upgrades">
				<div class="pad">
