...
<form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="userForm">
	...
	<?php
		for ($i=0;  $i < count($this->rows); $i++) {
			...
			$link_edit 		  = JRoute::_('index.php?option=com_jblance&view=project&layout=editprojectcustom&pid='.$row->id);	
			...
			$link_reopen_proj = JRoute::_('index.php?option=com_jblance&task=project.reopenproject&pid='.$row->id.'&'.JSession::getFormToken().'=1');
