...
<form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="userFormMessage" id="userFormMessage" class="form-validate" onsubmit="return validateForm(this);" enctype="multipart/form-data">
		...
		<div class="media-body">
        	...
        	<div>
        		...
        		<span id="feed_hide_<?php echo $row->id; ?>" class="help-inline">
					<a class="alink" onclick="processMessage('<?php echo $row->id; ?>', 'message.processmessage');" href="javascript:void(0);">
	...
	<div class="control-group">
		<div class="controls well">
			<textarea name="message" id="message" rows="3" class="input-block-level read-textare-mb required" placeholder="<?php echo JText::_('COM_JBLANCE_ENTER_MESSAGE'); ?>"></textarea>
			<div class="sp10">&nbsp;</div>
