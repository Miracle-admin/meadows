						...
						<a href="javascript:showMap()" title="Show Map">
							<?php 
								if((isset($this->package->features) && in_array(GOOGLE_MAP,$this->package->features) || !$appSettings->enable_packages ) 
									...
									echo '<img src="http://maps.googleapis.com/maps/api/staticmap?center='.$this->company->latitude.','.$this->company->longitude.'&zoom=13&size=300x106&markers=color:blue|'.$this->company->latitude.','.$this->company->longitude.'&sensor=false">';
								}
							?>
						</a> 	
