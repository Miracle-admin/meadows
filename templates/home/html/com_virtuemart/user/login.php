...
<div class="order-view">
  ...
  <form action="<?php echo JRoute::_( 'index.php', 1, $this->useSSL); ?>" method="post" name="com-login" >
    <div class="" id="com-form-order-number">
    ...
    <div class="" id="com-form-order-pass">
    ...
    <div class="" id="com-form-order-submit">
      <input type="submit" name="Submitbuton" class="abtn" value="<?php echo vmText::_('COM_VIRTUEMART_ORDER_BUTTON_VIEW') ?>" />
    </div>
    <div class="clr"></div>
...
<form id="com-form-login" action="<?php echo JRoute::_('index.php', $this->useXHTML, $this->useSSL); ?>" method="post" name="com-login" >
  <fieldset class="userdata">
    ...
    <div>
      <h1><?php echo vmText::_('COM_VIRTUEMART_ORDER_CONNECT_FORM'); ?></h1>
      <p></p>
    </div>
    <div class="clear"></div>
    <?php } else { ?>
    ...
    <?php }   ?>
    <p class="" id="com-form-login-username">
    ...
    <p class="" id="com-form-login-password">
    ...
    <p class="" id="com-form-login-remember">
      <input type="submit" name="Submit" class="abtn" value="<?php echo vmText::_('COM_VIRTUEMART_LOGIN') ?>" />
    </p>
  </fieldset>
  <div class="clr"></div>
  <div class=""> <a href="<?php echo JRoute::_('index.php?option=com_users&view=remind'); ?>" rel="nofollow"> <?php echo vmText::_('COM_VIRTUEMART_ORDER_FORGOT_YOUR_USERNAME'); ?></a> </div>
  <div class=""> <a href="<?php echo JRoute::_('index.php?option=com_users&view=reset'); ?>" rel="nofollow"> <?php echo vmText::_('COM_VIRTUEMART_ORDER_FORGOT_YOUR_PASSWORD'); ?></a> </div>
  <div class="clr"></div>
...
<form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="login" id="form-login">
  ...
  <input type="submit" name="Submit" class="abtn" value="<?php echo vmText::_( 'COM_VIRTUEMART_BUTTON_LOGOUT'); ?>" />
  <input type="hidden" name="option" value="com_users" />
