...
$doc->addStyleSheet($this->baseurl . '/templates/' . $this->template . '/css/custom.css', $type = 'text/css', $media = 'screen,projection');
$doc->addStyleSheet($this->baseurl . '/templates/' . $this->template . '/css/font-awesome.css', $type = 'text/css', $media = 'screen,projection');
$doc->addStyleSheet($this->baseurl . '/templates/' . $this->template . '/css/jquery.bxslider.css', $type = 'text/css');
...
$doc->addScript($this->baseurl . '/templates/' . $this->template . '/js/jquery.bxslider.js', 'text/javascript');
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $this->language; ?>" lang="<?php echo $this->language; ?>" dir="<?php echo $this->direction; ?>" >
    ...
    <body class="existingclass <?php echo $pageclass ? htmlspecialchars($pageclass) : 'default'; ?>">
        ...
        <!--<header>
          <div class="nav-wrapper-outer container">
            <div class="row">
              ...
              <nav class="col-md-8 col-sm-8 "> </nav>
        ...
        <jdoc:include type="modules" name="home-banner-inner"  />
        <!--//home banner-->
        ...
        <jdoc:include type="modules" name="search-app"  />
        <!--//search module--> 
        ...
        $app = JFactory::getApplication();
        $menu = $app->getMenu();
        // echo JRequest::getVar("option"); die;
        if ($menu->getActive() == $menu->getDefault() && JRequest::getVar("option") != "com_search") {
            ?>
        ...
        <div class="container" id="meadoes-content-wrap">
            ...
            if (JRequest::getVar("option") != "com_search")
                if ($this->countModules('position-15')) :
                    ?>
