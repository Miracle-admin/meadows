 ...
 */
class alphauserpointsController extends JControllerLegacy
{
	/**
	 * Custom Constructor
	 */
	...
	*/
	public function publish() {
		...
		$option		= JFactory::getApplication()->input->get( 'option', 'com_alphauserpoints', 'cmd' );
	...
	public function changeuserlevel() {
    	...
    	$this->setRedirect('index.php?option=com_alphauserpoints&task=cpanel');
    	$this->redirect();
	...
	public function stats() {
		...
		$_average_age = _get_average_age_communityAdm();
	...
	*/
	...
	public function processarchive()
	{
		...
		// Display
    	$this->setRedirect('index.php?option=com_alphauserpoints&task=cpanel&recalculate=start');
   		$this->redirect();		
	}
	...
	*/
	...
	public function resetUserConfirmed()
	{
	  ...
	  $this->setRedirect('index.php?option=com_alphauserpoints&task=statistics', $msg, $msgType);
	  $this->redirect();
	...
	public function resetprofilviews()
	{
		...
		$db->query();		
	  	...
	  	$this->setRedirect('index.php?option=com_alphauserpoints&task=edituser&cid[]='.$cid);
	  	$this->redirect();				
	}
