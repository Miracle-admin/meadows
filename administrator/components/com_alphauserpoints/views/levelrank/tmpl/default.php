...
<div class="clr"></div>
<!-- File Upload Form -->
<form action="<?php echo JURI::base(); ?>index.php?option=com_alphauserpoints&amp;task=upload&amp;tmpl=component&amp;<?php echo JSession::getFormToken();?>=1" name="uploadForm" id="uploadForm" method="post" enctype="multipart/form-data">
