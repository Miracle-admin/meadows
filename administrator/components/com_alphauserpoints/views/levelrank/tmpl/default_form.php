...
<div class="clr"></div>
<!-- File Upload Form -->
<form action="<?php echo JURI::base(); ?>index.php?option=com_alphauserpoints&amp;task=upload&amp;tmpl=component&amp;<?php echo JSession::getFormToken();?>=1" id="uploadForm" method="post" enctype="multipart/form-data" >
<div class="width-100 fltrt">
	<fieldset class="adminform">
