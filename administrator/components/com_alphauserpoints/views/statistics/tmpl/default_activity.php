	...
	<table class="table table-striped table-hover">
		...
		<?php
			...
			for ($i=0, $n=count( $this->userDetails ); $i < $n; $i++)
			{
				...
				$link 	= 'index.php?option=com_alphauserpoints&amp;task=edituserdetails&amp;cid[]='. $row2->id. '&amp;name=' . $row->name . '';
				...
				$approved = '<img src="'.JURI::base(true).'/components/com_alphauserpoints/assets/images/'. $imgA .'" border="0" alt="'. $altA .'" />'
				;
