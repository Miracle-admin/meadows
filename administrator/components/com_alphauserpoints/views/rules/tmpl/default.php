	...
	<table class="table table-striped table-hover">
		...
		<?php
			...
			for ($i=0, $n=count( $this->rules ); $i < $n; $i++)
			{
				...
				$showmessage = $row->displaymsg ? '<img src="'.JURI::base(true).'/components/com_alphauserpoints/assets/images/megaphone.png" border="0" alt="'.JText::_( 'AUP_DISPLAY_MESSAGE_ON_FRONTEND' ).'" />' : '' ;
				$sendnotification = $row->notification ? '<img src="'.JURI::base(true).'/components/com_alphauserpoints/assets/images/send_mail.png" border="0" alt="'.JText::_( 'AUP_EMAILNOTIFICATIONDESCRIPTION' ).'" />' : '' ;
