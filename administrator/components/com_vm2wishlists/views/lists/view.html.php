...
/**
 * View class for a list of Vm2wishlists.
 */
class Vm2wishlistsViewLists extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        Vm2wishlistsHelper::addSubmenu('lists');
    ...
    protected function addToolbar() {
        ...
        $canDo = Vm2wishlistsHelper::getActions($state->get('filter.category_id'));

        JToolBarHelper::title(JText::_('COM_VM2WISHLISTS_TITLE_LISTS'), 'lists.png');
        ...
        if ($canDo->get('core.admin')) {
            JToolBarHelper::preferences('com_vm2wishlists');
        }

        //Set sidebar action - New in 3.0
        JHtmlSidebar::setAction('index.php?option=com_vm2wishlists&view=lists');
	...
	protected function getSortFields()
	{
		...
		'a.list_name' => JText::_('COM_VM2WISHLISTS_LISTS_LIST_NAME'),
		'a.privacy' => JText::_('COM_VM2WISHLISTS_LISTS_PRIVACY'),
