...
<form action="<?php echo JRoute::_('index.php?option=com_jbusinessdirectory&view=managecategories');?>" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
	<fieldset  class="boxed">
		<div class="form-box">
			<h2> <?php echo JText::_('LNG_CATEGORIES_EXPORT_CSV');?></h2>
			<div>
				<?php echo JText::_('LNG_CATEGORIES_EXPORT_CSV_TEXT');?>									
			</div>			
			</br/></br/>
	 ...
	 <input type="hidden" name="task" id="task" value="managecategories.exportCategoriesCsv" /> 
