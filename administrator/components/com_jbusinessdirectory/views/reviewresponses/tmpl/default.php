	...
	<table class="table table-striped adminlist"  id="itemList">
		<thead>
			<tr>
				...
				<th class="hidden-phone"><?php echo JHtml::_('grid.sort', 'LNG_EMAIL', 'rr.email', $listDirn, $listOrder); ?></th>
				<th class="hidden-phone"><?php echo JHtml::_('grid.sort', 'LNG_STATE', 'rr.state', $listDirn, $listOrder); ?></th>
		...
		<tbody>
			...
			foreach($this->items as $reviewresponse) { ?>
				<tr class="row<?php echo $nrcrt%2?>" onmouseover="this.style.cursor='hand';this.style.cursor='pointer'" onmouseout="this.style.cursor='default'">
					...
					<td class="hidden-phone"><?php echo $reviewresponse->email ?></td>
