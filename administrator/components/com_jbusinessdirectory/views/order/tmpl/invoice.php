	...
	<table class="product" width="95%">
		...
		<tbody>
			<tr>
				...
				<td align="right">1</td>
				<td align="right"><?php echo $this->item->initial_amount ?> <?php echo $this->appSettings->currency_name?></td>
				<td align="right"><?php echo $this->item->initial_amount ?> <?php echo $this->appSettings->currency_name?></td>
			</tr>
			<tr>
				<td colspan="5">&nbsp;</td>
			...
			<?php if($this->item->discount_amount>0){?>
				<tr>
					...
					<td align="right"><?php echo $this->item->discount_amount ?> <?php echo $this->appSettings->currency_name?></td>
				</tr>
			<?php } ?>
			<tr>
				<td align="right" colspan="4"><b><?php echo JText::_('LNG_SUB_TOTAL'); ?>:</b></td>
				<td align="right"><?php echo number_format($this->item->initial_amount- $this->item->discount_amount,2) ?> <?php echo $this->appSettings->currency_name?></td>
			</tr>
			<?php if($this->appSettings->vat>0){?>
				<tr>
					<td align="right" colspan="4"><b><?php echo JText::_('LNG_VAT'); ?> (<?php echo $this->appSettings->vat?>%):</b></td>
					<td align="right"><?php echo number_format($this->item->vat_amount,2) ?> <?php echo $this->appSettings->currency_name?></td>
				</tr>
			<?php } ?>
			<tr>
				<td align="right" colspan="4"><b><?php echo JText::_('LNG_TOTAL'); ?>:</b></td>
				<td align="right"><?php echo number_format($this->item->amount,2) ?> <?php echo $this->appSettings->currency_name?></td>
			</tr>
		</tbody>
	</table>
