	...
	<ul class="main-categories" id="categories-menu-container">
		...
		<li class="main-cat">
			...
			<ul class="subcategories">
				...
				?>
				<li class="subcat"><a href="<?php echo JBusinessUtil::getOfferCategoryLink($subcategory[0]->id, $subcategory[0]->alias) ?>"><?php echo $subcategory[0]->name ?></a></li>
				<?php }
				...
				?>
						...
						?>
							<li class="subcat">
								<a href="<?php echo JBusinessUtil::getOfferCategoryLink($subcategory[0]->id, $subcategory[0]->alias) ?>"><?php echo $subcategory[0]->name ?></a>
			...
			<h2>
				<a href="<?php echo JBusinessUtil::getOfferCategoryLink($category[0]->id, $category[0]->alias) ?>"><?php echo $category[0]->name?> </a><i></i>
			</h2>
		</li>
		<?php } ?>
	</ul>	
