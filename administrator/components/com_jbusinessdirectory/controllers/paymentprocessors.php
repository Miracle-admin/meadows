...
class JBusinessDirectoryControllerPaymentProcessors extends JControllerAdmin
{
	/**
	 * Display the view
	 *
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'PaymentProcessor', $prefix = 'JBusinessDirectoryModel', $config = array('ignore_request' => true))
	{
	...
	public function delete()
	{
		...
		$this->setRedirect('index.php?option=com_jbusinessdirectory&view=paymentprocessors');
	}
