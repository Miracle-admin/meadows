 ...
 */
 ...
 class TablePlanbenefits extends JTableNested {
	...
	var $params = null; */
 	...
 	function __construct(JDatabaseDriver $db){
 		parent::__construct('#__jblance_planbenefits', 'id', $db);
 	}
 	...
 	public function getChildren($parent_id){
 		...
 		$query	= "SELECT n.id,n.title FROM #__jblance_planbenefits AS n, #__jblance_planbenefits AS p ".
 	...
 	public function getParent($child_id){
 		...
 		$query	= "SELECT p.id,p.title FROM #__jblance_planbenefits AS n, #__jblance_planbenefits AS p ".
