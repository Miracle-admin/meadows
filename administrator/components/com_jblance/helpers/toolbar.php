...
//Dashboard
	...
	public static function _EDIT_PLAN(){
        ...
        JToolBarHelper::custom('admconfig.saveplanwc', 'save.png', 'save_f2.png', 'Save', false, false);
	...
	public static function _EDIT_LOCATION(){
		...
		//CONFIGURATION : PLANBENEFITS
	public static function _SHOW_PLANBENEFITS(){
		JToolBarHelper::title(JText::_('Configuration: Plan Benefits'), 'joombri');
		JToolBarHelper::custom('admconfig.removeplanbenefits', 'delete.png', 'delete_f2.png', 'JTOOLBAR_DELETE', true, true);
		JToolBarHelper::custom('admconfig.newplanbenefits', 'new.png', 'new_f2.png', 'JTOOLBAR_NEW', false, false);
	}
	
	public static function _EDIT_PLANBENEFITS(){
		$app	= JFactory::getApplication();
		$cid	= $app->input->get('cid', array(), 'array');
		$isNew	= (empty($cid)) ? true : false; //if it is new job, cid = 0
		$text	= ($isNew ? JText::_('JTOOLBAR_NEW') : JText::_('JTOOLBAR_EDIT'));
		JToolBarHelper::title( JText::_('Configuration: Plan Benefits') .': [ '.$text.' ]', 'joombri');
		JToolBarHelper::custom('admconfig.saveplanbenefits', 'save.png', 'save_f2.png', 'JTOOLBAR_SAVE', false,  false);
		if($isNew)
			JToolBarHelper::custom('admconfig.cancelplanbenefits', 'cancel.png', 'cancel_f2.png', 'JTOOLBAR_CANCEL', false, false);
		else
			JToolBarHelper::custom('admconfig.cancelplanbenefits', 'cancel.png', 'cancel_f2.png', 'JTOOLBAR_CLOSE', false, false);
	}
