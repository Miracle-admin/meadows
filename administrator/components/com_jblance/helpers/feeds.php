...
class FeedsHelper {
	...
	function myProjectLink($target){
		...
		if($target == $user->id){
			...
			$html = JHtml::_('link', $myProjectURL, '<img src="components/com_jblance/images/preview.png" />');
		}
		return $html;
	}
	...
	function myBidLink($target){
		...
		if($target == $user->id){
			...
			$html = JHtml::_('link', $myBidURL, '<img src="components/com_jblance/images/preview.png" />');
		}
		return $html;
	}
