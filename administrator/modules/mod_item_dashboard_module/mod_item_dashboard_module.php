...
echo "We were unable to load Joobi library for the module Joobi - Items. If you removed the joobi folder, please also remove this module from the Joomla module manager.";
