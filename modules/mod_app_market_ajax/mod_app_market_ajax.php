...
$appmarket = modAppMarketAjaxHelper::getAppmarket($params);
$appmarketcat = modAppMarketAjaxHelper::getAppmarketCat($params);
require JModuleHelper::getLayoutPath('mod_app_market_ajax');
