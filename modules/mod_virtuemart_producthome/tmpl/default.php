...
$col = 1;
$pwidth = ' width' . floor (100 / $params->get('products_per_row'));
if ($params->get('products_per_row') > 1) {
	$float = "floatleft";
} else {
	$float = "center";
}
...
<div class="vmgroup<?php echo $params->get ('moduleclass_sfx') ?>">
	...
	<div class="vmheader"><?php echo $params->get('headerText') ?></div>
	<?php
}
	if ($params->get('display_style') == "div") {
		?>
		<div class="vmproduct<?php echo $params->get ('moduleclass_sfx'); ?> productdetails">
			...
			<?php
			if ($col == $params->get('products_per_row') && $params->get('products_per_row') && $col < $params->get('totalProd')) {
		...
		<ul class="vmproduct<?php echo $params->get ('moduleclass_sfx'); ?> productdetails">
			...
			<li class="<?php echo $pwidth ?> <?php echo $float ?>">
				...
				if ($params->get('show_price') and  isset($product->prices)) {
			...
			<?php
			if ($col == $params->get('products_per_row') && $params->get('products_per_row') && $last) {
				echo '
