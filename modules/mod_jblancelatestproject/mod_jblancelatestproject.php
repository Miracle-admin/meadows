...
$limit_desc    = intval($params->get('limit_project_desc', 200));
...
$project_upgrade=intval($params->get('project_upgrade', 0));
$rows 			= ModJblanceLatestprojectHelper::getLatestProjects($total_row,$limit_title,$limit_desc,$project_upgrade);

require(JModuleHelper::getLayoutPath('mod_jblancelatestproject'));
?>