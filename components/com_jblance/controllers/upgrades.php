        ...
        <script type="text/javascript">
            ...
            function upgradeList()
            {
			   ...
			   ldr.show();
                ...
                {
				    ldr.hide();
                    alert("You have already promoted your project , to all the available options.");
                }
        ...
        <div class="modal-content" style="min-width: 1000px;">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
					...
					<span class="loading"><img id="loading" style="display:none;" src="<?php echo JUri::root() ?>images/loading-bar.gif"/></span>
...
//if the user is owner of project
        if ($userId == $publisher_userid && $subtotal <= $totalFund) {
            ...
            if ($row->store()) {
				...
				$jbmail->sendProjectupgradeNotificationUser($pid, $userId);
