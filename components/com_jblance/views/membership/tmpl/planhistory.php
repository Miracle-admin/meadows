...
<form action="<?php echo $action; ?>" method="post" name="userFormJob" enctype="multipart/form-data">
    ...
    <?php if (count($this->rows) > 0) { ?>
                ...
                <tbody>
                    ...
                    foreach ($this->rows AS $row) {
                        ...
                        <tr>
                            ...
                            <?php //echo "<pre>"; print_r($row->approved); die(' -- ');?>
                            <td class="text-center">
                                <table class="btn-group">
                                    <?php if (!$row->approved): ?>
                                        <a class="btn btn-small" title="<?php echo JText::_('COM_JBLANCE_CHECKOUT'); ?>" href="<?php echo $link_checkout; ?>"><i class="icon-shopping-cart"></i>Checkout</a>
                                        <a class="btn btn-small" title="<?php echo JText::_('COM_JBLANCE_CANCEL_SUBSCR'); ?>" href="javascript:modalConfirm('<?php echo JText::_('COM_JBLANCE_CANCEL_SUBSCR', true); ?>', '<?php echo JText::_('COM_JBLANCE_CONFIRM_CANCEL_SUBSCR', true); ?>', '<?php echo $link_cancelsubscr; ?>');"><i class="icon-ban-circle">Subscribe</i></a>
                                    <?php endif; ?>
                                    <a class="btn btn-small jb-modal" title="<?php echo JText::_('COM_JBLANCE_PRINT_INVOICE'); ?>" href="<?php echo $link_invoice; ?>" rel="{handler: '', size: {x: 650, y: 500}}"><i class="icon-print"></i> Print</a>
                                </table>
                            </td>
                        </tr>
                        <?php
        ...
        <ul class="inline">
            <li style="float: left"><img src="components/com_jblance/images/s0.png" alt=""> <?php echo JText::_('COM_JBLANCE_APPROVAL_PENDING'); ?> | </li>
            <li  style="float: left"><img src="components/com_jblance/images/s1.png" alt=""> <?php echo JText::_('COM_JBLANCE_APPROVED'); ?> | </li>
            <li  style="float: left"><img src="components/com_jblance/images/s2.png" alt=""> <?php echo JText::_('COM_JBLANCE_CANCELLED'); ?> | </li>
            <li  style="float: left"><img src="components/com_jblance/images/s3.png" alt=""> <?php echo JText::_('COM_JBLANCE_EXPIRED'); ?></li>
        </ul>
        <?php
    }
    else {
...
jQuery(document).ready(function(){
    ...
    jQuery(document).on(".icon-print", "click", function(){
        alert('dsfg');
