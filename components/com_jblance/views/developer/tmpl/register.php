...
<form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="regNewUser"  enctype="multipart/form-data" id="developerRegistration">
	...
	<fieldset>
	<legend><?php echo JText::_('COM_JBLANCE_DEVELOPER_INFORMATION'); ?></legend>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<div id="status_url" class="dis-inl-blk"></div>
			</div>
		</div>
			<div class="control-group">
			<div class="controls">
			<label class="control-label" for="worktype"><?php echo JText::_('COM_JBLANCE_WORKTYPE'); ?> <span class="redfont">*</span>:</label>
				<?php foreach($work as $value){ ?>
				   ...
				   <input type="radio" name="work" <?php echo $app->getUserState('work','')==$value[0] ||  $value[0] == '76' ? ' checked="checked"':''; ?> value="<?php echo $value[0];?>"><?php echo $value[1]; ?>
				<?php } ?>
			</div>
	...
	<fieldset>
	<legend><?php echo JText::_('COM_JBLANCE_DEVELOPER_ACCOUNT'); ?></legend>
	<div class="control-group">
				...
				<ul class="featured-labels">			
					<li class="grey-box">
						<table border="0" width="100%" cellpadding="3" cellspacing="3">
							<tbody><tr>
							  <td>
								<input type="radio"  name="plan_id" <?php if ($plan_id == $plan->id || $plan->id==13 ) echo ' checked="checked"'; ?> id="form_<?php echo $planParams->heading; ?>" value="<?php echo $plan->id; ?>">
								<label for="form_<?php echo $planParams->heading; ?>" class="labelCheckbox"></label>
							  </td>
							  <td><span class="labels label-plane <?php echo $planParams->heading; ?>"><?php echo $planParams->heading; ?></span></td>
							  <td style="width:671px;"><b><?php echo $planParams->heading ." "; ?></b><?php echo $planParams->short_desc; ?>
							  <a href="<?php echo JRoute::_('index.php?option=com_jblance&view=membership&layout=plans', false); ?>" target="_blank">See more</a>
							  </td>
							  <td style="width:80px;">
								<?php if($plan->price == 0) { ?>
