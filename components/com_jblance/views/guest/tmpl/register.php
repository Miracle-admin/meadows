...
<?php echo JText::_('COM_JBLANCE_FIELDS_COMPULSORY'); ?>
	...
	<legend><?php echo JText::_('COM_JBLANCE_USER_INFORMATION'); ?></legend>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" name="username" id="username" class="inputbox hasTooltip required validate-username" onchange="checkAvailable(this);" title="<?php echo JHtml::tooltipText(JText::_('COM_JBLANCE_TT_USERNAME')); ?>"> 
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" name="email" id="email" class="inputbox hasTooltip required validate-email" onchange="checkAvailable(this);" title="<?php echo JHtml::tooltipText(JText::_('COM_JBLANCE_TT_EMAIL')); ?>">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="password" name="password" id="password" class="inputbox hasTooltip required validate-password" title="<?php echo JHtml::tooltipText(JText::_('COM_JBLANCE_TT_PASSWORD')); ?>">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="password2"><?php echo JText::_('COM_JBLANCE_CONFIRM_PASSWORD'); ?> <span class="redfont">*</span>:</label>
			<div class="controls">
				<input type="password" size="40" maxlength="100" name="password2" id="password2" class="inputbox hasTooltip required validate-password" title="<?php echo JHtml::tooltipText(JText::_('COM_JBLANCE_TT_REPASSWORD')); ?>">
			</div>
		</div>
	</fieldset>
