            ...
            <div class="fleft">
                ...
                <div class="box-project-dashboard white-box">
                    ...
                    <?php } else { ?>
                        ...
                        <h1>Waiting for approval by <a target="_blank" href="<?php echo JRoute::_("index.php?option=com_jblance&view=user&layout=viewprofile&id=" . $assigneduser->id . "&Itemid=198"); ?>"><?php echo $assigneduser->name; ?></a></h1>
                        <p>Once <?php echo $assigneduser->name; ?> accepts/rejects your proposel, you would be notified in the notification area.</p>
                                                ...
                                                <table width="100%" cellspacing="3" cellpadding="3" border="0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><span class="price"><?php echo $config->currencySymbol . $planparams->buyFeePerUrgentProject; ?></span></td>
                                                        </tr>
                                            ...
                                            <li class="grey-box">
                                                <table width="100%" cellspacing="3" cellpadding="3" border="0">
                                                    <tbody><tr>
                                                            ...
                                                            <td><span class="price"><?php echo $config->currencySymbol . $planparams->buyFeePerPrivateProject; ?></span></td>
                                                        </tr>
                                                    </tbody></table>          
                                            </li>
                                        <?php } ?>                               
                                            ...
                                            <li class="grey-box">
                                                <table width="100%" cellspacing="3" cellpadding="3" border="0">
                                                    <tbody><tr>
                                                            ...
                                                            <td><span class="price"><?php echo $config->currencySymbol . $planparams->buyFeePerFeaturedProject; ?></span></td>
                                                        </tr>
                                                    </tbody></table>          
                                            </li>
                                        <?php } ?>
                                            ...
                                            <li class="grey-box">
                                                <table width="100%" cellspacing="3" cellpadding="3" border="0">
                                                    <tbody><tr>
                                                            ...
                                                            <td><span class="price"><?php echo $config->currencySymbol . $planparams->buyFeePerAssistedProject; ?></span></td>
                                                        </tr>
                                                    </tbody></table>          
                                            </li>
