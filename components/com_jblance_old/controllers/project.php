...
//index.php?option=com_jblance&view=project&layout=detailproject&id=285
        if ($row->id) {
            $redirect = JRoute::_(JUri::base() . "index.php?option=com_jblance&view=project&layout=detailproject&id=" . $jbProject->id);
        } else {
            $redirect = JRoute::_(JUri::base() . "index.php?option=com_jblance&task=project.projectdashboard&id=" . $jbProject->id);
        }
    ...
    private function saveProjectregistration() {
        ...
        if ($user->save()) {
            ...
            //redirect else
            $app->redirect(JRoute::_(JUri::base() . "index.php?option=com_jblance&task=project.projectdashboard&id=" . $jbProject->id), 'Project successfully added', 'message');
        }
    }
    ...
    function projectDashboard() {
        ...
        $routes = array("1" => $root . "index.php?option=com_jblance&view=project&layout=projectdashboard&id=" . $id . "&Itemid=340", "2" => $root . "index.php?option=com_jblance&view=project&layout=pickuser&id=" . $id . "&Itemid=308", "3" => $root . "index.php?option=com_jblance&view=project&layout=agreement&id=" . $id, "4" => $root . "index.php?option=com_jblance&view=project&layout=projectprogress&id=" . $bId . "&Itemid=308&pid=" . $id, "5" => $root . "index.php?option=com_jblance&view=project&layout=rateuser&id=" . $rat['id'] . "&Itemid=308&pid=" . $id);
        $route = $routes[$step];
    ...
    function returnafterpayment() {
        ...
        $redirect = JRoute::_(JUri::base() . "index.php?option=com_jblance&task=project.projectdashboard&id=" . $pj_id . "&Itemid=340");
    ...
    public function resendRegistrationmail() {
        ...
        $jbmail = JblanceHelper::get('helper.email');
        $id = JRequest::getInt('id');
        $redirect = JRoute::_(JUri::root() . 'index.php?option=com_jblance&task=project.projectdashboard&id=' . $id);
    ...
    public function upgradeProject() {
        ...
        $jbmail = JblanceHelper::get('helper.email');
        $redirect = JRoute::_('index.php?option=com_jblance&view=project&layout=projectdashboard&id=' . $pid . '&Itemid=340');
        ...
        if ($isOwnedOperation) {
            ...
            $app->redirect(JRoute::_('index.php?option=com_jblance&view=project&layout=projectdashboard&id=' . $pid . '&Itemid=340', 'Please select any upgrade to purchase.', 'error'));
        }
    }
