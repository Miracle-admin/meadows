...
<img id="output"/>
	...
	<?php if($silverAccess){ for($i=0;$i<5;$i++) {  
	...
	<fieldset id="apps">
	    ...
	    <div class="control-group">
			...
			<div class="controls">
				<input data-validation="length" data-validation-length="max50" data-validation-optional="true" <?php echo $disabled; ?> class="input-large" value="<?php echo $this->extra_fields['field_id_1'][$i]; ?>" type="text" name="field_id_1[]" id="field_id_1" value="" /><span class="field_tip">{tip Wow!::Now I can give something a cool tooltip!}<img src="images/help.png"/>{/tip}</span>
			</div>
		</div>
	    ...
	    <div class="control-group">
			...
			<div class="controls">
				<input data-validation="length" data-validation-length="max50" data-validation-optional="true" <?php echo $disabled; ?> class="input-large" type="text" name="field_id_2[]" id="field_id_2" value="<?php echo $this->extra_fields['field_id_2'][$i]; ?>" /><span class="field_tip">{tip Wow!::Now I can give something a cool tooltip!}<img src="images/help.png"/>{/tip}</span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<span class="field_tip">{tip Wow!::Now I can give something a cool tooltip!}<img src="images/help.png"/>{/tip}</span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<textarea data-validation="length" data-validation-length="max500" data-validation-optional="true" <?php echo $disabled; ?>  class="input-large" type="text" name="field_id_4[]" id="field_id_4" ><?php echo $this->extra_fields['field_id_4'][$i]; ?> </textarea><span class="field_tip">{tip Wow!::Now I can give something a cool tooltip!}<img src="images/help.png"/>{/tip}</span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input data-validation="url" data-validation-optional="true" <?php echo $disabled; ?>  class="input-large" type="text" name="field_id_5[]" id="field_id_5" value="<?php echo $this->extra_fields['field_id_5'][$i]; ?>" /><span class="field_tip">{tip Wow!::Now I can give something a cool tooltip!}<img src="images/help.png"/>{/tip}</span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<div class="prev_image app-img-<?php echo $i; ?>" id="prev_image_apps<?php echo $i; ?>">
				<a href="media/developer/<?php echo $user->id.'/'.$this->extra_fields['field_id_6'][$i]; ?>" target="_blank" type="image" class="jcepopup" title="<?php echo $this->extra_fields['field_id_2'][$i]; ?>">
                <img  src="media/developer/<?php echo $user->id.'/thumbnails/'.$this->extra_fields['field_id_6'][$i]; ?>" alt="" />
                </a>
		  ...
		  style="<?php echo $display; ?>" class="input-large" <?php echo $disabled; ?>  type="file" name="field_id_6[]" id="field_id_6-<?php echo $i; ?>"  />
				...
				<span class="field_tip">
				{tip Wow!::Now I can give something a cool tooltip!}<img src="images/help.png"/>{/tip}</span>
			</div>
		</div>
	...
	<p>
		...
		<div class="up_subscription upsbscr_yourapps"><div class="disabled_field">
		<img src="<?php JUri::root() ?>images/disabledfields/your-apps.png"/>
		
		</div>
		<div class="renewsubscription">
		<a href="#">Upgrade To Silver Geek</a>
		</div></div>
	...
	<div class="control-group">
			...
			<div class="controls">
				<input data-validation="length" data-validation-length="max50" data-validation-optional="true" <?php echo $disabled; ?> class="input-large" type="text" name="field_id_7[]" id="field_id_7" value="<?php echo $this->extra_fields['field_id_7'][$i]; ?>" /><span class="field_tip">{tip Wow!::Now I can give something a cool tooltip!}<img src="images/help.png"/>{/tip}</span>
			</div>
		</div>
			...
			<div class="controls">
				<input data-validation="length" data-validation-length="max50" data-validation-optional="true" <?php echo $disabled; ?> class="input-large" type="text" name="field_id_8[]" id="field_id_8" value="<?php echo $this->extra_fields['field_id_8'][$i]; ?>" /><span class="field_tip">{tip Wow!::Now I can give something a cool tooltip!}<img src="images/help.png"/>{/tip}</span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<textarea data-validation="length" data-validation-length="max500" data-validation-optional="true" <?php echo $disabled; ?> class="input-large" type="text" name="field_id_10[]" id="field_id_10" ><?php echo $this->extra_fields['field_id_10'][$i]; ?></textarea><span class="field_tip">{tip Wow!::Now I can give something a cool tooltip!}<img src="images/help.png"/>{/tip}</span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input data-validation="url" data-validation-optional="true" <?php echo $disabled; ?> class="input-large" type="text" name="field_id_11[]" id="field_id_11" value="<?php echo $this->extra_fields['field_id_11'][$i]; ?>" /><span class="field_tip">{tip Wow!::Now I can give something a cool tooltip!}<img src="images/help.png"/>{/tip}</span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<div class="prev_image widg-img-<?php echo $i; ?>" id="prev_image_apps<?php echo $i; ?>">
				<a href="media/developer/<?php echo $user->id.'/'.$this->extra_fields['field_id_12'][$i]; ?>" target="_blank" type="image" class="jcepopup" title="<?php echo $this->extra_fields['field_id_8'][$i]; ?>">
                <img  src="media/developer/<?php echo $user->id.'/thumbnails/'.$this->extra_fields['field_id_12'][$i]; ?>" alt="" />
                </a>
	...
	<p>
		...
		<div class="up_subscription upsbscr_yourrole"><div class="disabled_field">
		<img src="<?php JUri::root() ?>images/disabledfields/your-widgets.png"/>
	...
	<?php if($goldAccess){ for($i=0;$i<5;$i++) {  
	$hidden =$i>0?"display:none;":"display:block;";
	$disabled = $i>0?"disabled='disabled'":"";
	...
	<fieldset id="experience">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input data-validation="length" data-validation-length="max50" data-validation-optional="true" <?php echo $disabled; ?> class="input-large" type="text" name="field_id_13[]" id="field_id_13" value="<?php echo $this->extra_fields['field_id_13'][$i]; ?>" /><span class="field_tip">{tip Wow!::Now I can give something a cool tooltip!}<img src="images/help.png"/>{/tip}</span>
			</div>
		</div>
			...
			<div class="controls">
				<input data-validation="length" data-validation-length="max50" data-validation-optional="true" <?php echo $disabled; ?> class="input-large" type="text" name="field_id_14[]" id="field_id_14" value="<?php echo $this->extra_fields['field_id_14'][$i]; ?>" /><span class="field_tip">{tip Wow!::Now I can give something a cool tooltip!}<img src="images/help.png"/>{/tip}</span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<textarea data-validation="length" data-validation-length="max500" data-validation-optional="true" <?php echo $disabled; ?> class="input-large" type="text" name="field_id_16[]" id="field_id_16" ><?php echo $this->extra_fields['field_id_16'][$i]; ?></textarea><span class="field_tip">{tip Wow!::Now I can give something a cool tooltip!}<img src="images/help.png"/>{/tip}</span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input data-validation="url" data-validation-optional="true" <?php echo $disabled; ?> class="input-large" type="text" name="field_id_17[]" id="field_id_17" value="<?php echo $this->extra_fields['field_id_17'][$i]; ?>" /><span class="field_tip">{tip Wow!::Now I can give something a cool tooltip!}<img src="images/help.png"/>{/tip}</span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<div class="prev_image exp-img-<?php echo $i; ?>" id="prev_image_apps<?php echo $i; ?>">
				<a href="media/developer/<?php echo $user->id.'/'.$this->extra_fields['field_id_18'][$i]; ?>" target="_blank" type="image" class="jcepopup" title="<?php echo $this->extra_fields['field_id_14'][$i]; ?>">
                <img  src="media/developer/<?php echo $user->id.'/thumbnails/'.$this->extra_fields['field_id_18'][$i]; ?>" alt="" />
                </a>
	...
	<?php } else { ?>
	<div class="up_subscription upsbscr_exp"><div class="disabled_field">
		<img src="<?php JUri::root() ?>images/disabledfields/your-experience.png"/>
		
		</div>
		<div class="renewsubscription">
		<a href="#">Upgrade To Gold Geek</a>
		</div></div>
	<?php } ?>
		<?php if($goldAccess) { for($i=0;$i<5;$i++) {  
	$hidden =$i>0?"display:none;":"display:block;";
	...
	<fieldset id="qualifications">
	    ...
	    <div class="control-group">
			...
			<div class="controls">
				<input  data-validation="length" data-validation-length="max50" data-validation-optional="true" <?php echo $disabled; ?> class="input-large" type="text" name="field_id_19[]" id="field_id_19" value="<?php echo $this->extra_fields['field_id_19'][$i]; ?>" /><span class="field_tip">{tip Wow!::Now I can give something a cool tooltip!}<img src="images/help.png"/>{/tip}</span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<textarea data-validation="length" data-validation-length="max500" data-validation-optional="true" <?php echo $disabled; ?> class="input-large" type="text" name="field_id_21[]" id="field_id_21" ><?php echo $this->extra_fields['field_id_21'][$i]; ?></textarea><span class="field_tip">{tip Wow!::Now I can give something a cool tooltip!}<img src="images/help.png"/>{/tip}</span>
			</div>
		</div>
	...
	<p>
		...
		<img src="<?php JUri::root() ?>images/disabledfields/your-qualifications.png"/>
	...
	<div class="control-group">
			...
			<div class="controls">
				<input data-validation="url" data-validation-optional="true" <?php echo $disabled; ?>  class="input-large" type="text" name="field_id_22[]" id="field_id_22" value="<?php echo $this->extra_fields['field_id_22'][$i]; ?>" /><span class="field_tip">{tip Wow!::Now I can give something a cool tooltip!}<img src="images/help.png"/>{/tip}</span>
			</div>
	</div>
	...
	<p>
	 ...
	 <?php } else {  ?>
	 <div class="up_subscription upsubscr_yourqualifications"><div class="disabled_field">
		<img src="<?php JUri::root() ?>images/disabledfields/your-websites.png"/>
	...
	<?php if($platinumAccess) { for($i=0;$i<5;$i++) {  
	$hidden =$i>0?"display:none;":"display:block;";
	$disabled = $i>0?"disabled='disabled'":"";
	?>
	...
	<div class="control-group">
			...
			<?php if(isset($this->extra_fields['field_id_23'][$i])): 
			...
			?>
			<div class="prev_video vid-tour-<?php echo $i; ?>" id="prev_video_vto<?php echo $i; ?>">
			<a href="<?php echo $path; ?>" target="_blank" type="video/mp4" class="jcepopup" data-mediabox-controls="controls" data-mediabox-poster="images/logo.png" data-mediabox-height="483" title="Video tour:Office" data-mediabox-width="854"><img src="images/film-strip.png"/></a>
			...
			<input data-validation="mime size" data-validation-allowing="mp4" data-validation-max-size="20M"  data-validation-optional="true" <?php echo $disabled; ?> style="<?php echo $display; ?>" class="input-large" type="file" name="field_id_23[]" id="field_id_23-<?php echo $i; ?>"  /><span class="field_tip">{tip Wow!::Now I can give something a cool tooltip!}<img src="images/help.png"/>{/tip}</span>
				</div>
	</div>
	...
	<?php } else { ?>
    <div class="up_subscription upsubscr_yourweb"><div class="disabled_field">
		<img src="<?php JUri::root() ?>images/disabledfields/video-tour-office.png"/>
		
		</div>
		<div class="renewsubscription">
		<a href="#">Upgrade To Platinum Geek</a>
		</div></div>
    <?php } ?>	
	<?php if($platinumAccess) { for($i=0;$i<5;$i++) {  
	$hidden =$i>0?"display:none;":"display:block;";
	...
	<div class="control-group">
			...
			<?php if(isset($this->extra_fields['field_id_24'][$i])): 
			...
			?>
			<div class="prev_video test-vid-<?php echo $i; ?>" id="prev_video_vto<?php echo $i; ?>">
			<a href="<?php echo $path; ?>" target="_blank" type="video/mp4" class="jcepopup" data-mediabox-controls="controls" data-mediabox-poster="images/logo.png" data-mediabox-height="483" title="Video tour:Office" data-mediabox-width="854"><img src="images/film-strip.png"/></a>
			<div  class="remove_pic"><a  id="test-vid-<?php echo $i; ?>" class="btn btn-danger" data-remove="field_id_24-<?php echo $i; ?>" href="#">Remove</a></div>
				...
				<input style="<?php echo $display; ?>" data-validation="mime size" data-validation-allowing="mp4" data-validation-max-size="20M"  data-validation-optional="true" <?php echo $disabled; ?> class="input-large" type="file" name="field_id_24[]" id="field_id_24-<?php echo $i; ?>"  /><span class="field_tip">{tip Wow!::Now I can give something a cool tooltip!}<img src="images/help.png"/>{/tip}</span>
	...
	<div class="up_subscription upsubscr_testimonial"><div class="disabled_field">
		<img src="<?php JUri::root() ?>images/disabledfields/testimonial.png"/>
	...
	<fieldset id="link_sm">
	    <div class="control-group">
			...
			<div class="controls">
				<input data-validation="url" data-validation-optional="true" <?php echo $disabled; ?> class="input-large" type="text" name="field_id_25[]" id="field_id_25" value="<?php echo $this->extra_fields['field_id_25'][$i]; ?>" /><span class="field_tip">{tip Wow!::Now I can give something a cool tooltip!}<img src="images/help.png"/>{/tip}</span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="field_id_26">Google+ URL</label>
			<div class="controls">
				<input data-validation="url" data-validation-optional="true" <?php echo $disabled; ?> class="input-large" type="text" name="field_id_26[]" id="field_id_26" value="<?php echo $this->extra_fields['field_id_26'][$i]; ?>" /><span class="field_tip">{tip Wow!::Now I can give something a cool tooltip!}<img src="images/help.png"/>{/tip}</span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input data-validation="url" data-validation-optional="true" <?php echo $disabled; ?> class="input-large" type="text" name="field_id_27[]" id="field_id_27" value="<?php echo $this->extra_fields['field_id_27'][$i]; ?>" /><span class="field_tip">{tip Wow!::Now I can give something a cool tooltip!}<img src="images/help.png"/>{/tip}</span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input data-validation="url" data-validation-optional="true" <?php echo $disabled; ?> class="input-large" type="text" name="field_id_28[]" id="field_id_28" value="<?php echo $this->extra_fields['field_id_28'][$i]; ?>" /><span class="field_tip">{tip Wow!::Now I can give something a cool tooltip!}<img src="images/help.png"/>{/tip}</span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input data-validation="url" data-validation-optional="true" <?php echo $disabled; ?> class="input-large" type="text" name="field_id_29[]" id="field_id_29" value="<?php echo $this->extra_fields['field_id_29'][$i]; ?>" /><span class="field_tip">{tip Wow!::Now I can give something a cool tooltip!}<img src="images/help.png"/>{/tip}</span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input data-validation="url" data-validation-optional="true" <?php echo $disabled; ?> class="input-large" type="text" name="field_id_30[]" id="field_id_30" value="<?php echo $this->extra_fields['field_id_30'][$i]; ?>" /><span class="field_tip">{tip Wow!::Now I can give something a cool tooltip!}<img src="images/help.png"/>{/tip}</span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input data-validation="url" data-validation-optional="true" <?php echo $disabled; ?> class="input-large" type="text" name="field_id_31[]" id="field_id_31" value="<?php echo $this->extra_fields['field_id_31'][$i]; ?>" /><span class="field_tip">{tip Wow!::Now I can give something a cool tooltip!}<img src="images/help.png"/>{/tip}</span>
			</div>
		</div>
	...
	<div class="disabled_field">
		<img src="<?php JUri::root() ?>images/disabledfields/social-media.png"/>
...
width: 390px;
 ...
 .upsbscr_yourqualifications  .renewsubscription
{
   position: relative;
    bottom: 136px;
    left: 260px;
...
.upsubscr_yourqualifications	.renewsubscription
 {
    position: relative;
    bottom: 79px;
    left: 338px;
...
.upsubscr_yourweb .renewsubscription{
    position: relative;
    left: 264px;
    bottom: 78px;
	width: 390px;
}
.upsubscr_testimonial .renewsubscription{
    position: relative;
    bottom: 75px;
    left: 263px;
	width: 390px;
 ...
 .upsubscr_sm .renewsubscription{
    position: relative;
    left: 265px;
    bottom: 223px;
	width: 390px;
}
.upsbscr_yourapps .renewsubscription
{   position: relative;
    left: 333px;
    bottom: 207px;
	width: 240px;
 ...
 .upsbscr_yourrole   .renewsubscription
 {  
    position: relative;
    left: 341px;
    bottom: 220px;
