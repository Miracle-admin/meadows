...
$jbmail->sendNewProjectRegistrationNotificationUser(300, JFactory::getUser());
        ...
        <div class="dev-reg-common">
            <div class="input_sign_up_wrapper top-hdr-post">
                ...
                <div class="control-group textarea-desp">
                    <textarea name="pz_desc"  placeholder="Project Description" data-validation="required" data-validation-error-msg="Please fill project description." class="message_box_wrapper"><?php echo ($app->getUserState('pz_desc', '')) ? $app->getUserState('pz_desc', '') : $prj_dec; ?></textarea></div>
