...
<form action="<?php echo $action; ?>" method="post" name="userForm">
	...
	<div class="row-fluid">
		...
		<div >
		<a href="<?php echo JUri::root(); ?>index.php?option=com_jblance&view=membership&layout=managepay" style="border: 1px solid;background: red;color: #fff;padding: 8px;border-radius: 8px;">View Payments</a>
		</div>
		<div >
		<a href="#" style="border: 1px solid;background: #0600FF;color: #fff;padding: 8px;border-radius: 8px;float: left;
