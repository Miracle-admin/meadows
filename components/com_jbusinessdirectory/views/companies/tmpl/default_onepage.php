  ...
  <div class="row">
      ...
      <div class="row-fluid">
        <div id="company-info" class="company-info">
          ...
          <div class="company-info-container" >
            <div class="rating-wrapper-appdev">
              <div class="company-info-rating" itemscope itemtype="http://data-vocabulary.org/Review-aggregate" <?php echo !$appSettings->enable_ratings? 'style="display:none"':'' ?>> <span style="display:none" itemprop="itemreviewed"><?php echo $this->company->name?></span> <span style="display:none" itemprop="rating" itemscope itemtype="http://data-vocabulary.org/Rating"> <span itemprop="average"><?php echo $this->company->averageRating?></span> <span itemprop="best">5</span> </span> <span  style="display:none" itemprop="count"><?php echo count($this->reviews)?></span>
                <div class="company-info-average-rating">
                  <div class="rating">
                    <div id="rating-average" title="<?php echo $this->company->averageRating?>"></div>
                  </div>
                  <p class="rating-text"> <?php echo JText::_('LNG_AVG_OF') ?> <span id="average-rating-count"> <span id="rateNumber<?php echo $this->company->id?>" itemprop="votes"> <?php echo $this->ratingCount ?> </span> <?php echo JText::_('LNG_RATINGS') ?></span></p>
                </div>
              ...
              <div class="company-info-review" <?php echo !$appSettings->enable_reviews? 'style="display:none"':'' ?>>
                <div style="display:none" class="login-awareness tooltip">
                  <div class="arrow">»</div>
                  <div class="inner-dialog"> <a href="javascript:void(0)" class="close-button" onclick="jQuery(this).parent().parent().hide()"><?php echo JText::_('LNG_CLOSE') ?></a>
                    <p> <strong><?php echo JText::_('LNG_INFO') ?></strong> </p>
                    <p> <?php echo JText::_('LNG_YOU_HAVE_TO_BE_LOGGED_IN') ?> </p>
                    <p> <a href="<?php echo JRoute::_('index.php?option=com_users&view=login'); ?>"><?php echo JText::_('LNG_CLICK_LOGIN') ?></a> </p>
                  </div>
                </div>
            ...
            <div>
              <div class="company-info-details">
                ...
                <div id="contact-person-details" class="contact-person-details"> 
                  <!--	<div onclick="jQuery('#contact-person-details').toggleClass('')" class="person-name"><strong >: </strong>  (+)</div> -->
                  <ul>
                    <li><?php echo JText::_('LNG_CONTACT_PERSON') ?> : <?php echo $company->contact_name?></li>
                ...
                <?php } ?>
                <p class="locatio-address"> <span itemprop="address" itemscope="" itemtype="http://schema.org/PostalAddress"> <i class="dir-icon-map-marker"></i> <?php echo JBusinessUtil::getAddressText($this->company) ?> </span> </p>
                ...
                <span class="phone" itemprop="tel"> <i class="dir-icon-phone"></i> <a href="tel:<?php  echo $this->company->phone; ?>">
                <?php  echo $this->company->phone; ?>
                </a> </span>
                <?php } ?>
                <?php if(!empty($this->company->mobile)) { ?>
                <span class="phone" itemprop="tel"> <i class="dir-icon-mobile-phone"></i> <a href="tel:<?php  echo $this->company->mobile; ?>">
                <?php  echo $this->company->mobile; ?>
                </a> </span>
                <?php } ?>
                <?php if(!empty($this->company->fax)) {?>
                <span class="phone"> <i class="dir-icon-fax"></i> <?php echo $this->company->fax?> </span>
                <?php } ?>
                <?php } ?>
                <?php if(!empty( $this->company->email) && $showData && $appSettings->show_email){?>
                <span itemprop="email"> <i class="dir-icon-envelope"></i> <?php echo $this->company->email?> </span>
                <?php } ?>
              </div>
            </div>
          </div>
          ...
          <div class="company-links">
            <ul class="features-links">
              ...
              <li> <a class="website" title="<?php echo $this->company->name?> Website" target="_blank" rel="nofollow"  href="<?php echo JRoute::_('index.php?option=com_jbusinessdirectory&view=companies&task=companies.showCompanyWebsite&companyId='.$company->id) ?>"> <i class="fa fa-globe"></i> <?php echo JText::_('LNG_WEBSITE') ?></a> </li>
              <?php }?>
              ...
              <li> <a class="email" href="javascript:showContactCompany()" ><i class="fa fa-envelope"></i> <?php echo JText::_('LNG_CONTACT_COMPANY'); ?></a> </li>
              <?php } ?>
            </ul>
        ...
        <?php if($showData){?>
        <div class="company-map"> <a href="javascript:showMap()" title="Show Map">
          <?php 
          ...
          <div class="claim-container" id="claim-container"> <a href="javascript:void(0)" onclick="claimCompany()">
            <div class="claim-btn"> <?php echo JText::_('LNG_CLAIM_COMPANY')?> </div>
            </a> </div>
          <?php  } ?>
        </div>
        <?php } ?>
      </div>
      <div id="company-map-holder"  class="">
        <?php /*?>	<div class="search-toggles">
			<span class="button-toggle">
				<a title="" class="" href="javascript:hideMap()"><?php echo JText::_("LNG_CLOSE_MAP")?></a>
			</span>
			<div class="clear"></div>
		</div><?php */?>
        <?php /*?><h2><?php echo JText::_("LNG_BUSINESS_MAP_LOCATION")?></h2><?php */?>
        <?php 
    ...
    <div class="col-md-8">
      <div class="company-menu">
        <nav> <a id="business-link" href="javascript:showDetails('company-business');" class="active"><?php echo JText::_("LNG_BUSINESS_DETAILS")?></a>
          <?php 
