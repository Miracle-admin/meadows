	...
	<div class="row-fluid">
		...
		<div id="search-path">
			<ul>
				...
				<li>
					<a class="search-filter-elem" href="<?php echo JRoute::_('index.php?option=com_jbusinessdirectory&view=events') ?>"><?php echo JText::_('LNG_ALL_EVENTS') ?></a>
				</li>
				<?php } ?>
			<?php 
				...
				?>
				<li>
					<a  class="search-filter-elem" href="<?php echo JBusinessUtil::getEventCategoryLink($path[0], $path[2]) ?>"><?php echo $path[1]?></a>
				</li>
			<?php }
				} 
			?>
